...
function App() {
  ...
  React.useEffect(() => {
    if (
      ...
      window.document.title = "Puraskrit - Portfolio";
      ...
      window.document.title = "Puraskrit - About";
      ...
      window.document.title = "Puraskrit - Projects";
      ...
      <section id="portfolio" ref={portfolioRef}>
        <header className="portfolio-header">
          <h1>
            ...
            <br />
            <span className="animate-character">Puraskrit</span>
            <span className="dotColorTheme">.</span>
            <br />
            <p className="profile">
              I'm a{" "}
              <span className="animate-character">Frontend Developer</span>{" "}
              based in Gurugram, India<span className="dotColorTheme">.</span>
            </p>
          </h1>
        </header>
        <Arrow />
